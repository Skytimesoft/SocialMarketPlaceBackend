...
class CategoryTable extends DataTableComponent
{
    ...
    {
        $this->emitUp('openCategoryDeleteModal', $category);
    }

    public function openCategoryEditModal(Category $category)
    {
        $this->emitUp('openCategoryEditModal', $category);
    }
